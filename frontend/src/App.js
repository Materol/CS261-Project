    ...
    <div className='App'>
      <Router>
        ...
        <Routes>
          ...
          <Route path='/login' element={<Login setIsLoggedIn={setIsLoggedIn} setFetchProjects={setFetchProjects} setUser={setUser} setEmail={setEmail} email={email} isLoggedIn={isLoggedIn} />} exact />
          <Route path='/register' element={<Register setIsLoggedIn={setIsLoggedIn} setFetchProjects={setFetchProjects} setUser={setUser} setEmail={setEmail} email={email} isLoggedIn={isLoggedIn} />}  exact />
          <Route path='/dashboard' element={<Dashboard fetchProjects={fetchProjects} setFetchProjects={setFetchProjects} isLoggedIn={isLoggedIn} user={user} email={email} />} exact />
          <Route path='/dashboard/createproject' element={<CreateProj setFetchProjects={setFetchProjects} isLoggedIn={isLoggedIn} email={email} />} exact />
