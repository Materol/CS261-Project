    ...
    <Container>
      ...
      <Row className="d-flex justify">
        ...
        <Col>
          ...
          <Button className="editButton" onClick={() => setPage(2)}>
            Edit
          </Button>
        </Col>
        <Col sm={4} />
      ...
      {CSFs[0].score > 0 ? (
                      ...
                      if (index < 6) {
                        return (
                          <tr>
                            ...
                            <td
                              style={{ backgroundColor: colourMap[csf.score] }}
                            >
                              {scoreLabels[csf.score]}
                            </td>
                          </tr>
                        );
                      } else {
        ...
        <h2 className="tm-4 mb-4">Update Critical Success Factors</h2>
      )}
      <Row>
        <Col sm={4} />
        <Col>
          {/* // button to go to the CSF page to redo questions */}
          <Button className="editButton" onClick={() => setPage(1)}>
            {" "}
            {CSFs[0].score > 0 ? "Redo CSFs" : "Update CSFs"}
          </Button>
        </Col>
        <Col sm={4} />
      </Row>
      ...
      <Row>
        ...
        <Col>
          ...
          <Button
            ...
            variant="success"
          >
            Update Project {IoCreateOutline}
          </Button>
        </Col>
        <Col sm={3} />
      </Row>
